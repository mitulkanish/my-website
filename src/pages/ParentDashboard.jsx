...
import { Award, Users, BookOpen, Calendar as CalendarIcon, BarChart3, TrendingUp, MessageCircleQuestion } from 'lucide-react';
    ...
    return (
        <div className="page-header">
            <div className="flex-between" style={{ marginBottom: '2rem' }}>
                ...
                <Link to="/complaints" className="btn-primary" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', textDecoration: 'none' }}>
